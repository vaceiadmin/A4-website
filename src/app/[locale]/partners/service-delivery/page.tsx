  ...
  const sections = [
    {
      ...
      content: [
        "A4 works with selected service delivery partners to support the execution of accounting, audit, and related professional services using structured workflows and controlled processes.",
    ...
    },
    {
      ...
      content: [
        ...
        "A4 provides the underlying workflows, portals, and operational structure that support planning, execution, review, and client communication. Service delivery partners operate within this structure according to agreed scopes and responsibilities.",
    ...
    },
    {
      ...
      content: [
        ...
        "At the outset of each engagement, the scope of services, responsibilities, and delivery roles are clearly defined. Work is planned and executed using A4 workflows and portals, ensuring traceability, version control, and clear ownership.",
    ...
    },
    {
      ...
      content: [
        ...
        "A4 provides the delivery infrastructure, workflow structure, and operational controls that support the engagement.",
    ...
    },
    {
      ...
      content: [
        ...
        "A4 reserves the right to apply quality checks to ensure that delivery standards are maintained across all partner-led engagements."
      ]
    },
    {
      title: "Use of Technology and Portals",
      content: [
        "Service delivery partners use A4’s technology to support execution and oversight.",
    ...
    },
    {
      ...
      content: [
        "Service delivery partners are assessed based on professional credentials, operational readiness, experience, and alignment with A4’s quality expectations.",
