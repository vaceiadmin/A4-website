  ...
  const sections = [
    {
      ...
      content: [
        "A4 provides technology enablement support for organisations that already operate their own accounting, audit, or compliance systems and want to improve structure, consistency, and delivery control.",
        "Under this model, A4 does not replace or license a full platform. Instead, A4 works alongside the organisation’s existing technology to assist with process structuring, workflow alignment, and technical implementation."
      ]
    },
    {
      ...
      content: [
        ...
        "A4 supports internal teams by applying proven delivery frameworks, workflow logic, and technical expertise to enhance current tools and processes.",
    ...
    {
      title: "How A4 Assists",
      content: [
        "A4 provides support through a dedicated technical and process-focused team.",
    ...
    },
    {
      ...
      content: [
        ...
        "A4 does not assume ownership of technology, make delivery decisions, or access client data beyond what is required for agreed support activities.",
        "A4’s role is advisory and technical, focused on enablement rather than operation."
      ]
    },
    {
      ...
      content: [
        ...
        "Access, permissions, and security are governed by the organisation’s internal policies and applicable regulatory requirements. A4 operates within agreed boundaries and confidentiality terms."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "This ensures that A4’s involvement adds value without creating dependency or operational risk."
      ]
    }
  ];
