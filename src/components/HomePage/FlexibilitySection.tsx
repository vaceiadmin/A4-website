        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                ...
                {(t("flexibility.options", { returnObjects: true }) as string[] || []).map((option, i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      isDark ? "bg-white/5 border-white/10 hover:border-primary-blue shadow-lg" : "bg-white border-slate-200 hover:border-zinc-500 shadow-xl shadow-zinc-500/5"
                    )}
                  >
                    <div className={cn(
                      "w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 transition-transform duration-500 group-hover:scale-110",
                      i === 0 ? (isDark ? "bg-primary-blue/20 text-primary-blue" : "bg-zinc-500/10 text-zinc-600") : (isDark ? "bg-emerald-500/20 text-emerald-500" : "bg-emerald-500/10 text-emerald-600")
                    )}>
          ...
          <div className="relative group">
            ...
            <div className={cn(
              ...
              isDark ? "bg-[#0A0B10] border-white/10 shadow-3xl" : "bg-white border-zinc-100 shadow-2xl shadow-zinc-500/10"
            )}>
              ...
              <div className="relative z-10 space-y-8">
                ...
                <div className={cn(
                  ...
                  isDark ? "bg-zinc-500/5 border-zinc-500/10 text-zinc-300" : "bg-zinc-50 border-zinc-100 text-zinc-700 shadow-inner"
                )}>
