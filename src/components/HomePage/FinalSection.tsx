    ...
    <section className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className={cn(
            ...
            isDark ? "bg-white/5 border-white/10" : "bg-white border-slate-200 shadow-xl shadow-zinc-500/5 hover:border-zinc-500/30"
        )}>
             {/* Dynamic Light Sweep */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-zinc-500/50 to-transparent opacity-30" />
            ...
            <div className="max-w-4xl mx-auto space-y-12 relative z-10">
                ...
                <div className={cn(
                    ...
                    <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bodoni italic text-zinc-500 leading-tight">
            ...
            <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-zinc-500/5 blur-[100px] rounded-full pointer-events-none group-hover/board:bg-zinc-500/10 transition-colors duration-700" />
            <div className="absolute -top-20 -left-20 w-80 h-80 bg-zinc-500/5 blur-[100px] rounded-full pointer-events-none" />
        </div>
      </div>
      ...
      <div className={cn(
          ...
          isDark ? "bg-primary-blue/10" : "bg-zinc-400/10"
      )} />
    </section>
  );
};
