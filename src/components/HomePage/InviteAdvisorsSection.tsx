  ...
  return (
    <section className="relative py-20 lg:py-28 bg-[#0B0D14] rounded-[48px] overflow-hidden border border-white/5 shadow-2xl">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-zinc-500/20 to-transparent opacity-50" />
        <div className="absolute -top-[10%] -left-[5%] w-[40%] h-[40%] bg-zinc-600/10 rounded-full blur-[120px] opacity-60 mix-blend-screen" />
        <div className="absolute bottom-[10%] -right-[5%] w-[30%] h-[40%] bg-zinc-600/10 rounded-full blur-[100px] opacity-40 mix-blend-screen" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start">
            <h2 className="text-4xl sm:text-5xl lg:text-[3.25rem] font-black text-white leading-[1.1] mb-6 tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-400 to-zinc-600">{t("inviteAdvisors.titleHighlight")}</span>
            </h2>
            ...
            <GetInstantQuoteButton 
              ...
              className="h-[56px] px-10 shadow-xl shadow-zinc-600/10 hover:shadow-zinc-600/20 bg-white text-slate-900 border-none"
              hasShadow={false}
            />
          </div>
            ...
            <div className="relative rounded-3xl overflow-hidden bg-[#09090B] border border-white/10 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.05)_inset] transition-all duration-700 hover:scale-[1.02] hover:border-zinc-500/30 w-full z-10">
              ...
              <div className="relative w-full aspect-[4/3] sm:aspect-video bg-[#050505] overflow-hidden flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center hidden text-slate-400 font-medium z-10 px-6 text-center bg-[#050505]/80 backdrop-blur-sm">
                  ...
                  <span className="text-sm">{t("inviteAdvisors.gifPlaceholderHint")} <br/> <code className="text-zinc-400">{t("inviteAdvisors.gifPlaceholderPath")}</code></span>
                </div>
              </div>
            </div>

            {/* Glowing ambient background behind the browser */}
            <div className="absolute inset-0 bg-zinc-600/20 rounded-full blur-[100px] -z-0 animate-pulse-subtle pointer-events-none group-hover:bg-zinc-600/30 transition-colors duration-700" />
          </div>
