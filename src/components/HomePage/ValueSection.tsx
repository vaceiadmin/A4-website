          ...
          <div className="flex flex-col gap-4 h-full animate-in fade-in slide-in-from-bottom-2 duration-700">
            ...
            <div className="flex-1 flex items-end gap-2.5 mt-4">
              {[40, 70, 45, 90, 65, 80, 50].map((h, j) => (
                <div key={j} className="flex-1 rounded-t-md relative group bg-zinc-50 dark:bg-slate-800/50" style={{ height: `${h}%` }}>
                  <div className={cn("absolute bottom-0 left-0 right-0 rounded-t-md transition-all duration-1000 ease-out", isDark ? "bg-gradient-to-t from-zinc-600 to-zinc-400" : "bg-gradient-to-t from-zinc-500 to-zinc-400")} style={{ height: '100%' }} />
                </div>
              ))}
            </div>
        ...
        return (
          <div className="flex flex-col h-full animate-in fade-in slide-in-from-bottom-2 duration-700">
            <div className="flex justify-between items-center mb-5">
              ...
              <span className="text-[10px] font-bold text-zinc-500 hover:text-zinc-600 cursor-pointer">View All</span>
            </div>
        ...
        return (
          <div className="flex flex-col h-full justify-center animate-in fade-in slide-in-from-bottom-2 duration-700">
            <div className="flex justify-between mb-6">
              ...
              <span className={cn("text-[10px] font-bold px-2 py-0.5 rounded-full border", isDark ? "bg-zinc-500/10 text-zinc-400 border-zinc-500/20" : "bg-zinc-50 text-zinc-600 border-zinc-200")}>In Progress</span>
            </div>
                  ...
                  <div key={j} className="flex items-center gap-5 relative z-10">
                    <div className={cn(
                      ...
                      step.status === 'completed' ? "bg-emerald-500 border-emerald-100 dark:border-emerald-900 text-white" :
                        step.status === 'active' ? (isDark ? "bg-primary-blue border-zinc-900 text-white" : "bg-zinc-600 border-zinc-100 text-white") :
      ...
      case 4:
        return (
          <div className="flex flex-col h-full justify-end gap-3 pb-2 animate-in fade-in zoom-in-[0.98] duration-700">
            <p className={cn("text-xs font-bold uppercase tracking-wider border-b pb-3 mb-2 flex justify-between", isDark ? "text-slate-500 border-white/5" : "text-slate-400 border-slate-100")}>Direct Message <span className="text-zinc-500 lowercase">Online</span></p>
            <div className="flex gap-3">
              <div className="w-8 h-8 rounded-full bg-zinc-100 overflow-hidden shrink-0 flex items-center justify-center text-zinc-500 shadow-sm border border-zinc-200">
            ...
            <div className="flex gap-3 flex-row-reverse mt-2">
              <div className={cn("p-4 rounded-2xl rounded-tr-none text-sm text-white shadow-md", isDark ? "bg-primary-blue border border-zinc-500/50" : "bg-zinc-600 border border-zinc-500")}>
          ...
          <div className="flex flex-col h-full justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className={cn("mx-auto p-6 rounded-[1.5rem] border text-center w-full max-w-[280px]", isDark ? "bg-[#0a0a0a] border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.5)]" : "bg-white border-slate-200 shadow-xl shadow-slate-200/50")}>
              <div className="flex justify-center -space-x-2 mb-5">
                <div className="w-12 h-12 rounded-full border-2 border-white dark:border-[#0a0a0a] bg-zinc-100 flex items-center justify-center text-zinc-600 relative overflow-hidden"><img src="https://i.pravatar.cc/100?img=12" alt="Avatar" className="w-full h-full object-cover" /></div>
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      ...
                      isActive
                        ? (isDark ? "bg-primary-blue text-white ring-zinc-400/30 shadow-lg shadow-zinc-500/20" : "bg-zinc-600 text-white")
                        : (isDark ? "bg-white/[0.06] text-slate-400 ring-white/10 group-hover:text-zinc-300" : "bg-slate-100 text-slate-400 group-hover:text-zinc-600")
                    )}>
                    ...
                    <div className={cn(
                      ...
                      isActive ? "bg-zinc-500 scale-150" : "bg-slate-300 opacity-0"
                    )} />
                  </button>
                );
              })}
              ...
              <div className="relative h-full p-6 sm:p-8">
                ...
                >
                  <video
                    ...
                    src="/assets/videos/A4%20(2)%20X2V2.mp4"
                    playsInline
                    preload="metadata"
