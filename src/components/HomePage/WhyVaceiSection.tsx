      ...
      <section className="py-24 bg-black relative overflow-hidden rounded-[48px]">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
               <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-zinc-500/10 text-zinc-400 text-[10px] font-black uppercase tracking-widest border border-zinc-500/20 mb-6">
                  {t("whyA4.badge")}
               </div>
               <SectionTitleHero
                  variant="dark"
                  className="mb-6 items-center text-center"
                  line1={t("whyA4.titleLine1")}
                  highlight={t("whyA4.titleHighlight")}
               />
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-16">
               ...
               <div className="md:col-span-8 p-10 md:p-12 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col justify-between group hover:shadow-xl transition-all duration-500 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-zinc-50 rounded-full blur-[80px] -mr-32 -mt-32 opacity-50 group-hover:opacity-100 transition-opacity" />
                  <div className="relative z-10 text-center flex flex-col items-center">
                     <div className="w-16 h-16 rounded-2xl bg-zinc-600 text-white flex items-center justify-center mb-8 shadow-xl shadow-zinc-600/20 group-hover:scale-110 transition-transform">
                        <Database className="w-8 h-8" />
                     </div>
                     <h3 className="text-3xl font-black text-slate-900 mb-4">{t("whyA4.card1Title")}</h3>
               ...
               <div className="md:col-span-4 p-8 md:p-10 rounded-[2.5rem] bg-slate-900 text-white flex flex-col justify-between group hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                     ...
                     <h3 className="text-xl font-black mb-3">{t("whyA4.card2Title")}</h3>
                     <p className="text-slate-400 text-sm font-medium leading-relaxed">
                        {t("whyA4.card2Body")}
                     </p>
                  </div>
                  <div className="relative z-10 mt-8 pt-8 border-t border-white/5 flex items-center justify-between">
                     <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500/80">{t("whyA4.qualityLabel")}</span>
            ...
            <div className="text-center">
               <GetInstantQuoteButton
                  text={t("whyA4.cta")}
                  className="h-[56px] px-12 shadow-xl shadow-zinc-600/20"
               />
            </div>
